        ...
        child: BlocBuilder<AuthBloc, AuthState>(
          builder: (context, state) {
            return Container(
              ...
              child: Flex(
                direction: context.screenHeight < 400
                    ? Axis.horizontal
                    : Axis.vertical,
                ...
                children: () {
                  ...
                  if (state is AuthHasLoggedInUser) {
                    final username = state.currentUser.isAnonymous
                        ? 'Anonymous'
...
List<Widget> _getLoginOptions(BuildContext context) {
  final cloudStorageOptionEnabled =
      context.read<PreferencesCubit>().state.storageOption!.withCloud;
  return [
    ...
    if (!kIsWindows && cloudStorageOptionEnabled)
      _CustomButton(
        onPressed: () {
